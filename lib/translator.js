...
Translator.prototype.translateAttributeValue = function(itemType, attributeName, value){
  if(typeof CONFIGS['xref'][itemType] != 'undefined'){
    if(typeof CONFIGS['xref'][itemType][attributeName] != 'undefined'){
      return CONFIGS['xref'][itemType][attributeName][value] ? CONFIGS['xref'][itemType][attributeName][value] : value;
      ...
      if(key != 'additional'){
        ...
        _.forEach(value, function(child){
          if((typeof child != 'string') && !(child instanceof Array)){
            ...
            if(typeof ret[self.translateKey(key, to_external)] == 'undefined') ret[self.translateKey(key, to_external)] = [];
