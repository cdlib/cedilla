  ...
  if(typeof name == 'string'){
    if(name.trim() != ''){
      ...
      this._target = helper.safeAssign('string', this._config['target'], undefined);
			...
			this._itemTypesReturned = this._config['items_types_returned'] || [];
			
			this._referrerBlock = helper.safeAssign('string', this._config['do_not_call_if_referrer_from'], undefined);
...
Service.prototype.call = function(item, headers, callback){
  ...
  if(typeof self._translator != 'undefined'){		
    ...
    _map = translator.translateMap(_map, true);
  }
