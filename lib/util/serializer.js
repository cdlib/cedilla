...
module.exports = {
  ...
  itemToJsonForService: function(transactionId, item, requestorParams){
    ...
    if(typeof requestorParams == 'undefined'){ requestorParams = {}; }
    ...
    if(typeof requestorParams['requestor_language'] != 'undefined'){ message += ',"requestor_language":"' + requestorParams['requestor_language'] + '"'; }
    if(typeof requestorParams['unmapped'] != 'undefined'){ message += ',"unmapped":"' + requestorParams['unmapped'] + '"'; }
    if(typeof requestorParams['original_request'] != 'undefined'){ message += ',"original_request":"' + requestorParams['original_request'] + '"'; }
  ...
  requestorToJson: function(requestor){
    var out = {};
    if(typeof requestor.getAffiliation() != 'undefined'){ out['affiliation'] = requestor.getAffiliation(); };
    if(typeof requestor.getIp() != 'undefined'){ out['ip'] = requestor.getIp(); };
    if(typeof requestor.getLanguage() != 'undefined'){ out['language'] = requestor.getLanguage(); };
    if(typeof requestor.getUserAgent() != 'undefined'){ out['agent'] = requestor.getUserAgent(); };
    if(requestor.hasIdentifiers()){ out['identifiers'] = requestor.getIdentifiers(); };
