...
var OpenUrlParser = function(openurl) {
  /*
...
// -----------------------------------------------------------------------------------------------
util.inherits(OpenUrlParser, events.EventEmitter);

// -----------------------------------------------------------------------------------------------
OpenUrlParser.prototype.getVersion = function() {
...
// ---------------------------------------------------------------------------------------------
OpenUrlParser.prototype.buildItemsFromQueryString = function(queryString, callback) {
  ...
  _.forEach(map, function(value, key) {
    if (!configHelper.wasMapped(item, key)) {
  ...
  var genre = configHelper.getCrossReference(item.getType(), 'genre', item.getAttribute('genre'));
...
// -----------------------------------------------------------------------------------------------
OpenUrlParser.prototype.parse = function(request, callback) {
  var self = this;
