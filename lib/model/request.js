  ...
  if(typeof params != 'undefined'){
    if(typeof params['referrers'] != 'undefined'){ 
      if(params['referrers'] instanceof Array){ 
        this._referrers = params['referrers']; 
      }else{ 
        this._referrers.push(params['referrers']); 
      } 
    }
    if(typeof params['type'] != 'undefined'){ this._type = params['type']; }
    if(typeof params['content_type'] != 'undefined'){ this._contentType = params['content_type']; }
...
Request.prototype.getDuration = function(){ if(this._end instanceof Date && this._start instanceof Date){ return this._end.getTime() - this._start.getTime(); } };

Request.prototype.getRequestor = function(){ return this._requestor; };
Request.prototype.setRequestor = function(requestor){ this._requestor = (requestor instanceof Requestor ? requestor : new Requestor(requestor)); };
...
Request.prototype.getContentType = function(){ return this._contentType; };
Request.prototype.setContentType = function(contentType){ this._contentType = contentType; };
...
Request.prototype.setErrors = function(errs){ return this._errors = errs; };
Request.prototype.getReferents = function(){ return this._referents; };
Request.prototype.setReferents = function(items){ this._referents = items; };
Request.prototype.getReferrers = function(){ return this._referrers; };
Request.prototype.setReferrers = function(referrers){ if(referrers instanceof Array){ this._referrers = referrers; }else{ this._referrers.push(referrers) } };
...
Request.prototype.hasReferents = function(){ return _.size(this._referents) > 0; };
Request.prototype.hasReferrers = function(){ return _.size(this._referrers) > 0; };
Request.prototype.hasUnmapped = function(){ return this._unmapped.length > 0; };

Request.prototype.addError = function(error){ this._errors.push(error); };
Request.prototype.addReferent = function(item){ this._referents.push(item); };
Request.prototype.addReferrer = function(referrer){ this._referrers.push(referrer); };
