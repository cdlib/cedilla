...
var Configs = function(){
  ...
  self._loadFileConfigs(process.cwd() + '/config', undefined);
    
  // Load the translator mapping files
  self._loadFileConfigs(process.cwd() + '/config/translators', 'translators');
      
  // Load the parser mapping files
  self._loadFileConfigs(process.cwd() + '/config/parsers', 'parsers');
	
  // Load the parser mapping files
  self._loadFileConfigs(process.cwd() + '/config/notifiers', 'notifiers');
...
// -----------------------------------------------------------------------------------------  
Configs.prototype._loadFileConfigs = function(dir, prefix){
  var self = this;
