...
exports.CONFIGS = CONFIGS = require("./lib/config.js");
...
var waitForConfigs = setInterval(function(){
  if(typeof CONFIGS['application'] != 'undefined' || i == 2000){
    ...
    exports.helper = helper = require("./lib/utils/helper.js");
    exports.serializer = serializer = require("./lib/utils/serializer.js");
    exports.Translator = Translator = require("./lib/utils/translator.js");
    exports.Consortial = Consortial = require("./lib/utils/consortial.js");
    exports.Request = Request = require("./lib/models/request.js");
    exports.Requestor = Requestor = require("./lib/models/requestor.js");
    exports.Item = Item = require("./lib/models/item.js");

    //module.exports = LOGGER = require('./lib/logger.js');
    exports.Broker = Broker = require("./lib/broker.js");
    exports.Tier = Tier = require("./lib/tier.js");
    exports.Service = Service = require("./lib/service.js");
    exports.OpenUrlParser = OpenUrlParser = require("./lib/parsers/openurl.js");

    // Setup logger
    exports.log = log = require('./lib/logger.js');
