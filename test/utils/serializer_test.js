...
describe("serializer.js", function() {
  ...
  before(function(done) {
    ...
    var delayStartup = setInterval(function() {
      if (typeof Item !== 'undefined') {
        ...
        var getAttributeMap = function(type, include_children) {
          var map = {};
  ...
  it('testing itemToJsonForService()', function() {
    ...
    // With request params
    json = JSON.parse(serializer.itemToJsonForService(transId, item, {"api_ver": service_api_ver,
  ...
  it('testing requestorToJson()', function() {
    ...
    json = JSON.parse(serializer.requestorToJson(requestor));
