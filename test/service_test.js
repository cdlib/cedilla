  ...
  before(function(done) {
    ...
    var delayStartup = setInterval(function() {
      if (typeof Item !== 'undefined') {
        ...
        // ---------------------------------------------------------------------------------------------------
        Service.prototype.getMaxAttempts = function() {
          return this._maxAttempts;
        };
        Service.prototype.setMaxAttempts = function(value) {
          this._maxAttempts = value;
        };
        Service.prototype.getTimeout = function() {
          return this._timeout;
        };
        Service.prototype.setTimeout = function(value) {
          this._timeout = value;
        };
        Service.prototype.getTranslator = function() {
          return this._translator;
        };
        Service.prototype.setTranslator = function(value) {
          this._translator = value;
        };
        Service.prototype.getTarget = function() {
          return this._target;
        };
        Service.prototype.setTarget = function(value) {
          this._target = value;
        };
        Service.prototype.setReferrerBlock = function(values) {
          this._referrerBlock = values;
        };
        Service.prototype.setItemTypes = function(values) {
          this._itemTypesReturned = values;
        };
...
// ---------------------------------------------------------------------------------------------------  
  it('should throw an error when the connection to the service is refused!', function(done) {
    ...
    svc.runTest('', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return a valid response from the service!', function(done) {
    ...
    svc.runTest('success', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return a 404 not found from the service!', function(done) {
    ...
    svc.runTest('not_found', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return a 400 bad request from the service!', function(done) {
    ...
    svc.runTest('bad_request', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return a 500 warning error from the service!', function(done) {
    ...
    svc.runTest('warning', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return a 500 error from the service!', function(done) {
    ...
    svc.runTest('error', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return a 500 fatal error from the service!', function(done) {
    ...
    svc.runTest('fatal', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return an id mismatch!', function(done) {
    ...
    svc.runTest('wrong_id', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return an timeout!', function(done) {
    ...
    svc.runTest('timeout', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return an error when the service returned an unknown item!', function(done) {
    ...
    svc.runTest('unknown_item', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return an error when the service does NOT return JSON!', function(done) {
    ...
    svc.runTest('not_json', item, function(params) {
      _params = params;
    });
  });
  ...
  it('should return an error when the response overflows the buffer!', function(done) {
    ...
    svc.runTest('flood_buffer', item, function(params) {
      _params = params;
    });
  });
